...
.controller('artistCtrl', ['$scope', '$http', '$location', 'dataFactory', '$stateParams','getArtists', 'getArtistUpcomingShows', artistCtrl])
...
function artistCtrl($scope, $http, $location, dataFactory, $stateParams, getArtists, getArtistUpcomingShows){
