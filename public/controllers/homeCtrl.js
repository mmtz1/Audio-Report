...
.directive('googlemap', function(dataFactory){
  return {
    ...
    link: function(scope, el, attrs){
      el.append('<div class="col-sm-12"><img style="width: 400px; height: 300px;" src="https://d13yacurqjgara.cloudfront.net/users/63485/screenshots/1136567/earth-gif-preloader.gif"></div>')
      var listOfEvents;
