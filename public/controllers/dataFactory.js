...
function dataFactory($http, $location, $rootScope, $q){
  ...
  dataFactory.artistIdEchoNest = function(artistName) {
    return $http.get('http://developer.echonest.com/api/v4/artist/search?api_key=T0OOMWQVXVAFNUL14&name=' + artistName)    
  };
  ...
  dataFactory.getArtistId = function(artistName){
    return $http.get('http://api.songkick.com/api/3.0/search/artists.json?query='+ artistName.artistname + ' &apikey=yAVnutMub1F9Xpe4')
  };
  dataFactory.getArtistConcerts = function(artistId){
    return $http.get('http://api.songkick.com/api/3.0/artists/' + artistId + '/calendar.json?apikey=yAVnutMub1F9Xpe4')
  }
  ...
  dataFactory.getMetroArea = function(lat, lon){
    return $http.get('http://api.songkick.com/api/3.0/search/locations.json?location=geo:'+ lat + ',' + lon + '&apikey=yAVnutMub1F9Xpe4')
  }

  dataFactory.getConcertsNearUser = function(metroId){
    return $http.get('http://api.songkick.com/api/3.0/metro_areas/' + metroId + '/calendar.json?apikey=yAVnutMub1F9Xpe4')
  }      
